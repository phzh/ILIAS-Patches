...
*
* @version $Id: class.ilObjContentObject.php 50205 2014-05-20 15:44:20Z akill $
*
...
//echo "ContObj:".$a_inst.":<br>";
	...
	*/
	function exportHTML($a_target_dir, $log, $a_zip_file = true, $a_export_format = "html", $a_lang = "")
	{
		...
		// PHZH: added 'icon_lm_b.png' to export for same header icon size as everywhere else
		copy(ilUtil::getImagePath("icon_lm_b.png", false, "filesystem"),
			$image_dir."/icon_lm_b.gif");
