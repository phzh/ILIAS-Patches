...
* @version $Id: class.ilLMPresentationGUI.php 51581 2014-07-19 14:36:05Z akill $
*
...
//		}
	...
	*/
	function ilLMHead()
	{
		...
		if ($this->offlineMode())
		{
			// PHZH: changed 'icon_lm.png' to 'icon_lm_b.png' for same header icon size as everywhere else
			$this->tpl->setVariable("IMG_HEADER", "./images/icon_lm_b.png");
		}
		else
		{
			// PHZH: changed 'icon_lm.png' to 'icon_lm_b.png' for same header icon size as everywhere else
			$this->tpl->setVariable("IMG_HEADER", ilUtil::getImagePath("icon_lm_b.png"));
		}
		$this->tpl->parseCurrentBlock();
